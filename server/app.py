...
from .routers import dashboard, connectors_api, wizard, boards, sessions, settings_api, pipelines, agents, auth, skills, quick_actions, environment, analytics
...
def create_app(data_dir: Path | None = None) -> FastAPI:
    ...
    app.include_router(quick_actions.router, prefix="/api/quick-actions", tags=["quick-actions"])
