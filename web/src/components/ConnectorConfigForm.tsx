...
const PLUGIN_FIELDS: Record<string, Field[]> = {
  ...
  copilot: [
    { key: 'github_connector_id', label: 'GitHub Connector ID', type: 'text', placeholder: 'github-main', wizard: true,
      hint: 'ID of the GitHub connector to inherit auth from. Leave blank to auto-discover.' },
    { key: 'working_dir', label: 'Default Working Directory', type: 'text', placeholder: '/workspace', wizard: true,
      hint: 'Default cwd for Copilot sessions inside the container.' },
    { key: 'board_dir', label: 'Board Directory', type: 'text', placeholder: 'hil-stress', defaultValue: 'hil-stress', wizard: true,
      hint: 'Subdirectory inside the workspace repo that contains config.yml and stage handlers.' },
